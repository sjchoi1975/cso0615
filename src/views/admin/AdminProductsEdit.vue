<template>
    <div class="auth-root">
      <h2 class="Signup-title">제품 수정</h2>
      <form @submit.prevent="updateProduct" class="auth-form">
        <label>기준년월</label>
        ...
        <div style="display: flex; gap: 0.5rem; margin-top: 1.2rem;">
          ...
          <button type="submit" class="btn-add" :disabled="loading" style="flex:1;">수정</button>
        </div>
      </form>
    </div>
  </template>
